  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link me-2" href="news.php">Tin Tức</a>
        </li>
        <li class="nav-item">
      ...
      <div class="d-flex" role="search">
		<a href="confirm.php" style="padding-right: 30px;"><i class="fa fa-shopping-cart" style="font-size:36px; color:black"></i></a>
