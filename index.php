...
<!-- Swiper Carousal-->
 	...
 	<div class="row">
 		...
 		<div class="col-lg-4 col-md-6 my-3">
 			<div class="card border-0 shadow" style="max-width: 350px; margin: auto;">
			  ...
			  <div class="card-body">
			    <h5 class="card-title">Phòng Bình Dân</h5>
 ...
 <div class="container">
 	<div class="row justify-content-evenly px-lg-0 px-md-0 px-5">
 		...
 		<div class="col-lg-12 text-center mt-5">
 			<a href="#" class="btn btn-sm btn-outline-dark rounded rounded-0 fw-bold shadow-none">Thêm >>></a>
 		</div>
 	</div>
 </div>
    ...
    <div class="swiper swiper-testimonials">
      <div class="swiper-wrapper mb-5">
        ...
        <div class="swiper-slide bg-white p-4">
          ...
          <p>
		  Tôi có một kỳ nghỉ thú vị tại BL Hotel. Mặc dù có một vài vấn đề nhỏ, nhưng dịch vụ tổng thể và trải nghiệm lưu trú của tôi rất tốt. Tôi sẽ xem xét quay lại trong tương lai. 
          </p>
          <div class="rating">
          	<i class="bi bi-star-fill text-warning"></i>
    		<i class="bi bi-star-fill text-warning"></i>
